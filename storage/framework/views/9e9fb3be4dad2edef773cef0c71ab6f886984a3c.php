	...
	<div class="col-6">
		<div class="card card-body">
			<form action="/menu" method="post" enctype="multipart/form-data">
				...
				<div class="form-floating mb-3">
					<textarea class="form-control" required value="<?php echo e(old('descMenu')); ?>" required name="descMenu" required placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea> 
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Restaurant\resources\views/menu/create.blade.php ENDPATH**/ ?>